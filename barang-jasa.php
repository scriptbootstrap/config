																		...
																		<div class="dropdown show">
																			...
																			<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																				...
																				<form action="bahkn/print-word" method="post">
																					...
																					<input type="text" hidden name="hari_terbilang" value="<?= $rowBAHKN["hari_terbilang"]; ?>">
																					<input type="text" hidden name="tgl_terbilang" value="<?= $rowBAHKN["tgl_terbilang"]; ?>">
																					<input type="text" hidden name="bln_terbilang" value="<?= $rowBAHKN["bln_terbilang"]; ?>">
																					<input type="text" hidden name="thn_terbilang" value="<?= $rowBAHKN["thn_terbilang"]; ?>">
																		...
																		<div class="dropdown show">
																			...
																			<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																				...
																				<form action="bahp/print-word" method="post">
																					...
																					<input type="text" hidden name="hari_terbilang" value="<?= $rowBAHP["hari_terbilang"]; ?>">
																					<input type="text" hidden name="tgl_terbilang" value="<?= $rowBAHP["tgl_terbilang"]; ?>">
																					<input type="text" hidden name="bln_terbilang" value="<?= $rowBAHP["bln_terbilang"]; ?>">
																					<input type="text" hidden name="thn_terbilang" value="<?= $rowBAHP["thn_terbilang"]; ?>">
																		...
																		<div class="form-button-action">
																			<div class="dropdown show">
																				...
																				<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																					...
																					<?php if ($row["ppn"] === "0") : ?>
																						<form action="spes/print-word-no-ppn" method="post">
																					...
																					<?php if ($row["ppn"] === "1") : ?>
																						<form action="spes/print-word" method="post">
																							...
																							<input type="text" hidden name="ppn" value="<?= number_format(11 / 100 * $rowSPes["harga_satuan"] * $rowSPes["vol"], 0, ',', '.'); ?>">
																		...
																		<div class="dropdown show">
																			...
																			<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																				...
																				<form action="bahpp/print-word" method="post">
																					...
																					<input type="text" hidden name="hari_terbilang" value="<?= $rowBAHPP["hari_terbilang"]; ?>">
																					<input type="text" hidden name="tgl_terbilang" value="<?= $rowBAHPP["tgl_terbilang"]; ?>">
																					<input type="text" hidden name="bln_terbilang" value="<?= $rowBAHPP["bln_terbilang"]; ?>">
																					<input type="text" hidden name="thn_terbilang" value="<?= $rowBAHPP["thn_terbilang"]; ?>">
																		...
																		<div class="dropdown show">
																			...
																			<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																				...
																				<form action="bapp/print-word" method="post">
																					...
																					<input type="text" hidden name="hari_terbilang" value="<?= $rowBAPP["hari_terbilang"]; ?>">
																					<input type="text" hidden name="tgl_terbilang" value="<?= $rowBAPP["tgl_terbilang"]; ?>">
																					<input type="text" hidden name="bln_terbilang" value="<?= $rowBAPP["bln_terbilang"]; ?>">
																					<input type="text" hidden name="thn_terbilang" value="<?= $rowBAPP["thn_terbilang"]; ?>">
																		...
																		<div class="dropdown show">
																			...
																			<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																				...
																				<form action="bast/print-word" method="post">
																					...
																					<input type="text" hidden name="hari_terbilang" value="<?= $rowBAST["hari_terbilang"]; ?>">
																					<input type="text" hidden name="tgl_terbilang" value="<?= $rowBAST["tgl_terbilang"]; ?>">
																					<input type="text" hidden name="bln_terbilang" value="<?= $rowBAST["bln_terbilang"]; ?>">
																					<input type="text" hidden name="thn_terbilang" value="<?= $rowBAST["thn_terbilang"]; ?>">
																		...
																		<div class="dropdown show">
																			...
																			<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																				...
																				<form action="bap/print-word" method="post">
																					...
																					<input type="text" hidden name="hari_terbilang" value="<?= $rowBAP["hari_terbilang"]; ?>">
																					<input type="text" hidden name="tgl_terbilang" value="<?= $rowBAP["tgl_terbilang"]; ?>">
																					<input type="text" hidden name="bln_terbilang" value="<?= $rowBAP["bln_terbilang"]; ?>">
																					<input type="text" hidden name="thn_terbilang" value="<?= $rowBAP["thn_terbilang"]; ?>">
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAPHK["hari_terbilang"]; ?>,
										<?= $rowBAPHK["tgl_terbilang"]; ?>,
										<?= $rowBAPHK["bln_terbilang"]; ?>,
										<?= $rowBAPHK["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAHKN["hari_terbilang"]; ?>,
										<?= $rowBAHKN["tgl_terbilang"]; ?>,
										<?= $rowBAHKN["bln_terbilang"]; ?>,
										<?= $rowBAHKN["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAHP["hari_terbilang"]; ?>,
										<?= $rowBAHP["tgl_terbilang"]; ?>,
										<?= $rowBAHP["bln_terbilang"]; ?>,
										<?= $rowBAHP["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAHPP["hari_terbilang"]; ?>,
										<?= $rowBAHPP["tgl_terbilang"]; ?>,
										<?= $rowBAHPP["bln_terbilang"]; ?>,
										<?= $rowBAHPP["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAPP["hari_terbilang"]; ?>,
										<?= $rowBAPP["tgl_terbilang"]; ?>,
										<?= $rowBAPP["bln_terbilang"]; ?>,
										<?= $rowBAPP["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAST["hari_terbilang"]; ?>,
										<?= $rowBAST["tgl_terbilang"]; ?>,
										<?= $rowBAST["bln_terbilang"]; ?>,
										<?= $rowBAST["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									<td>Terbilang</td>
									<td>:
										<?= $rowBAP["hari_terbilang"]; ?>,
										<?= $rowBAP["tgl_terbilang"]; ?>,
										<?= $rowBAP["bln_terbilang"]; ?>,
										<?= $rowBAP["thn_terbilang"]; ?>
									</td>
								</tr>
								<tr>
									<td>Nama Satker</td>
